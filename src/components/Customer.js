      ...
      <div className="container mx-auto max-w-7xl relative z-10">
        ...
        <AnimatedSection delay={0.1} direction="up">
            <div className="text-center mb-20 max-w-2xl mx-auto">
                <span className="inline-block px-4 py-1.5 rounded-full bg-slate-900 text-white font-bold text-[9px] tracking-[0.3em] uppercase mb-6 shadow-2xl">
                    Client Success
                </span>
              ...
              <div key={review.id} className="p-4 outline-none">
                <div className="bg-white p-10 rounded-[3rem] shadow-2xl border border-slate-100 h-full flex flex-col relative group transition-all duration-700 hover:border-pink-500/30">
                  ...
                  <div className="flex items-center gap-5 mt-auto relative z-10">
                    ...
                    <div>
                      <h6 className="font-heading font-black text-slate-900 tracking-wide uppercase text-sm">{review.name}</h6>
        ...
        <AnimatedSection delay={0.5} direction="up">
            <div className="flex justify-center mt-12">
                <button className="group relative px-12 py-5 bg-slate-900 text-white rounded-2xl text-[10px] font-black uppercase tracking-[0.3em] overflow-hidden shadow-2xl hover:-translate-y-1 transition-all duration-500">
