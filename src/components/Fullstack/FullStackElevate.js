    ...
    <section className="py-16 md:py-24 bg-white relative z-10 px-6 overflow-hidden font-roboto">
      ...
      <div className="container mx-auto relative z-10">
        <div className="bg-orange-50 rounded-[3rem] p-12 md:p-20 relative overflow-hidden">
          {/* Subtle glow */}
          <div className="absolute top-0 left-0 w-[400px] h-[400px] bg-white/50 rounded-full blur-[100px] -translate-y-1/2 -translate-x-1/2"></div>
              ...
              <AnimatedSection delay={0.1} direction="right">
                <div className="mb-10">
                  <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-6 capitalize tracking-tight leading-tight">
                    Hire Versatile <span className="text-orange-600">Full Stack</span> Teams
                  </h2>
                  <p className="text-slate-600 text-lg leading-relaxed mb-8">
                    Our full-stack developers are proficient in multiple technologies, allowing them to bridge the gap between complex business logic and intuitive user interfaces.
                  </p>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                  {[
                    { icon: <FaLayerGroup className="text-pink-500" />, label: "Full Spectrum" },
                    { icon: <FaCode className="text-orange-500" />, label: "Modern Stacks" },
                    { icon: <FaCheckCircle className="text-pink-500" />, label: "Quality First" }
                  ].map((item, index) => (
                ...
                <button className="mt-12 px-10 py-5 bg-slate-900 text-white rounded-2xl text-[11px] font-black capitalize tracking-[0.25em] shadow-2xl hover:bg-orange-600 transition-all duration-300">
