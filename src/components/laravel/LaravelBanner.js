          ...
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="lg:w-3/5">
              <div className="mb-10 text-center lg:text-left">
                <span className="inline-block px-4 py-1.5 rounded-full bg-slate-50 border border-slate-100 text-red-600 font-bold text-[10px] tracking-widest uppercase mb-6 shadow-sm">
                ...
                <div className="flex flex-wrap gap-4 justify-center lg:justify-start">
                    <button className="px-8 py-4 bg-slate-900 text-white rounded-2xl text-[11px] font-black uppercase tracking-[0.2em] shadow-lg shadow-slate-900/20 hover:bg-red-600 hover:-translate-y-1 transition-all duration-300">
                        Get A Free Quote
                    </button>
                </div>
              </div>
