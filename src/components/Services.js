            ...
            <AnimatedSection key={service.id} delay={service.delay} direction="up">
              <div className="group flex flex-col bg-white rounded-[2.5rem] overflow-hidden shadow-2xl transition-all duration-500 border border-slate-100 hover:border-pink-500/20 hover:-translate-y-3 relative">
                ...
                <div className="p-10 flex flex-col h-full relative z-10">
                  ...
                  {/* Title & Metadata */}
                  <div className="mb-6">
                    <span className="text-[10px] font-black text-slate-400 capitalize tracking-[0.25em] mb-2 block">
                      {service.subTitle}
                    </span>
                    <h3 className="font-heading text-2xl font-black text-slate-900 tracking-tight capitalize group-hover:text-pink-600 transition-colors">
                      {service.title}
                    </h3>
                  </div>
                  ...
                  {/* Button */}
                  <button className="flex items-center justify-between gap-3 w-full px-8 py-5 rounded-2xl bg-slate-50 border border-slate-100 hover:border-pink-500/50 hover:bg-slate-900 hover:text-white transition-all duration-500 font-black tracking-widest capitalize text-[10px] group/btn">
