    ...
    <section className="py-24 bg-slate-50 relative z-10 px-6 font-roboto overflow-hidden">
      ...
      <div className="container mx-auto max-w-7xl">
        <AnimatedSection delay={0} direction="up" className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-black text-slate-900 mb-6 capitalize tracking-tight">
              ...
              <div className="group flex flex-col bg-white rounded-3xl overflow-hidden shadow-xl border border-slate-100 hover:border-pink-500/20 transition-all duration-500 h-full hover:-translate-y-2">
                <div className="relative h-56 overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4">
                    <span className="px-3 py-1 bg-white/90 backdrop-blur-md rounded-full text-[10px] font-bold text-pink-600 capitalize tracking-widest shadow-sm">
                      Technology
                    </span>
                  </div>
                </div>
                ...
                <div className="p-8 flex flex-col flex-grow">
                  <div className="flex items-center gap-4 mb-4 text-[10px] font-bold text-slate-400 capitalize tracking-widest">
                  ...
                  <div className="pt-6 border-t border-slate-50 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-bold text-slate-900 capitalize tracking-widest">{post.author}</span>
                    </div>

                    <button className="flex items-center gap-2 text-pink-600 text-[10px] font-black capitalize tracking-widest group/link">
                      Read More
