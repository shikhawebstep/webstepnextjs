        ...
        <AnimatedSection delay={0.1} direction="up">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            ...
            <div className="lg:w-3/5">
              <div className="mb-10">
                <span className="inline-block px-4 py-1.5 rounded-full bg-white border border-slate-200 text-pink-500 font-bold text-[10px] tracking-widest uppercase mb-6 shadow-sm">
                  Our Blog & Insights
                </span>
                <h2 className="text-4xl md:text-6xl font-black leading-tight text-slate-900 mb-8 tracking-tight">
                  Driving Digital <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-orange-500 to-amber-500">Innovation</span>
                </h2>
