...
const QuoteForm = () => {
    return (
        <div className="flex flex-col h-full">
            <div className="mb-8">
                <h5 className="text-2xl font-black text-slate-900 mb-2 uppercase tracking-tight">
            ...
            <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                ...
                <div className="pt-2">
                    ...
                    <div className="flex items-center justify-center gap-2 mt-6 text-slate-400">
                        ...
                        <span className="text-[10px] uppercase tracking-widest font-bold">Data protection guaranteed</span>
                    </div>
                </div>
            </form>
        </div>
