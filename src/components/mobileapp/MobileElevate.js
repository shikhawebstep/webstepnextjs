          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 relative z-10">
            ...
            <div className="lg:w-2/3">
              <AnimatedSection delay={0.1} direction="right">
                ...
                <button className="mt-12 px-10 py-5 bg-slate-900 text-white rounded-2xl text-[11px] font-black uppercase tracking-[0.25em] shadow-2xl hover:bg-blue-600 transition-all duration-300">
                    Launch Your App
                </button>
              </AnimatedSection>
            </div>
