...
const ContactUs = () => {
  return (
    <section className="bg-white font-roboto">
        ...
        <div className="container mx-auto max-w-7xl relative z-10 px-6">
            <AnimatedSection delay={0.1} direction="up">
                <div className="text-center max-w-3xl mx-auto">
                    <span className="inline-block px-4 py-1.5 rounded-full bg-pink-500/10 border border-pink-500/20 text-pink-500 font-bold text-[10px] tracking-widest uppercase mb-6">
                        Get In Touch
                    </span>
      ...
      <div className="container mx-auto max-w-7xl relative z-10 px-6 -mt-16 lg:-mt-24 pb-20">
            ...
            <AnimatedSection delay={0.2} direction="left">
                <div className="bg-white p-8 rounded-[2.5rem] shadow-2xl border border-slate-100 flex flex-col gap-6">
                    <div className="flex items-start gap-5">
                        ...
                        <div>
                            <h4 className="font-black text-slate-900 text-sm uppercase tracking-wider mb-2">Our HQ</h4>
                    ...
                    <div className="flex items-start gap-5">
                        ...
                        <div>
                            <h4 className="font-black text-slate-900 text-sm uppercase tracking-wider mb-2">Call Us</h4>
                    ...
                    <div className="flex items-start gap-5">
                        ...
                        <div>
                            <h4 className="font-black text-slate-900 text-sm uppercase tracking-wider mb-2">Email</h4>
                ...
                <div className="mt-8 bg-slate-900 p-10 rounded-[2.5rem] shadow-2xl relative overflow-hidden group">
                    ...
                    <div className="relative z-10">
                        <h4 className="text-white font-black text-2xl mb-4 tracking-tight uppercase">Ready for <br /> global impact?</h4>
                        <p className="text-white/60 text-sm mb-8 leading-relaxed">Join 500+ businesses that scaled with our software solutions.</p>
                        <div className="flex items-center gap-2 text-pink-500 font-black text-[10px] tracking-widest uppercase">
                            <FaGlobe />
          ...
          <div className="lg:col-span-8 space-y-8">
            <AnimatedSection delay={0.3} direction="right">
                <div className="bg-white p-8 md:p-12 rounded-[3rem] shadow-2xl border border-slate-100 relative overflow-hidden">
                    ...
                    <div className="mb-10">
                        <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4 tracking-tight uppercase">Send us a Message</h2>
                ...
                <div className="mt-8 rounded-[3rem] overflow-hidden shadow-2xl border border-slate-100 h-[450px] relative group">
                    ...
                    <div className="absolute bottom-8 left-8 p-4 bg-white/90 backdrop-blur-md rounded-2xl border border-white/50 shadow-xl z-20 hidden md:flex items-center gap-4">
                        ...
                        <div>
                            <span className="block font-black text-[10px] uppercase tracking-widest text-slate-900">Visit Our Studio</span>
